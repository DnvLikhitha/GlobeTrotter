...
const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50">
      {/* Header */}
      <header className="bg-gradient-to-r from-blue-100/60 via-cyan-100/50 to-teal-100/60 backdrop-blur-md border-b border-cyan-200/40 sticky top-0 z-50 shadow-sm">
